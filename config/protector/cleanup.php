...
return [
    ...
    */
    'local_disk' => [
        ...
        |--------------------------------------------------------------------------
        |
        | Here you may configure the invokable which will be executed.
        |
        */
        'invokable' => \Cybex\Protector\Classes\Cleanup\CleanupLocalInvokable::class,
        ...
        | - schedule: Will schedule the invokable according to the cron expression below.
        ...
        */
        ...
        |
        | Here you may configure a cron expression for how often the cleanup invokable will be scheduled.
