...
class Protector
{
    ...
    public function getRemoteDump(): string
    {
        ...
        if (!$response->ok()) {
            ...
            throw match ($httpCode) {
                ...
                default => new HttpException($httpCode),
            };
        }
     ...
     * @return JsonResponse|StreamedResponse
     */
    public function generateFileDownloadResponse(AuthUser $user, string $connectionName = null, bool $disableTokenCheck = false): StreamedResponse|JsonResponse
    {
    ...
    protected function getConfiguredHttpRequest(): PendingRequest
    {
        ...
        return $request->withOptions(['stream' => true]);
    }
